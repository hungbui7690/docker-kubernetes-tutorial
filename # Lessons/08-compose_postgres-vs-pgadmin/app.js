...
\\\\\\\\\\\\\\\\\\\\\\\\
  ...
  Explain
  - 2 services: <postgresdb> and pgadmin.
    -> we will use the service name as the host to connect from pgadmin
    🚀 we just can use service name as the host when setup in the same docker-compose.yaml
  - Environments
...
\\\\\\\\\\\\\\\\\\\\\\\\\\
  ...
  docker-compose up --build
  - start 2 services: postgres and pgadmin
...
\\\\\\\\\\\\\\\\\\\\\\\\\\
  ...
  From PGAdmin Container [STILL NOT WORKING]
  - Open the pgAdmin in web browser. (http://localhost:5050/)
  - Login to pgAdmin
  - Add New Server
    # Host: <postgresdb> or <172.17.0.2>
    # Port: 6543
